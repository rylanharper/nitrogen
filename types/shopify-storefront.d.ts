...
export type BuyerIdentityFragment = { countryCode?: CountryCode | null, email?: string | null, phone?: string | null, customer?: { displayName: string, email?: string | null, id: string, defaultAddress?: { address1?: string | null, address2?: string | null, city?: string | null, company?: string | null, country?: string | null, countryCodeV2?: CountryCode | null, firstName?: string | null, formatted: Array<string>, formattedArea?: string | null, id: string, lastName?: string | null, latitude?: number | null, longitude?: number | null, name?: string | null, phone?: string | null, province?: string | null, provinceCode?: string | null, zip?: string | null } | null } | null };

export type CartFragment = { checkoutUrl: string, createdAt: string, id: string, totalQuantity: number, updatedAt: string, buyerIdentity: { countryCode?: CountryCode | null, email?: string | null, phone?: string | null, customer?: { displayName: string, email?: string | null, id: string, defaultAddress?: { address1?: string | null, address2?: string | null, city?: string | null, company?: string | null, country?: string | null, countryCodeV2?: CountryCode | null, firstName?: string | null, formatted: Array<string>, formattedArea?: string | null, id: string, lastName?: string | null, latitude?: number | null, longitude?: number | null, name?: string | null, phone?: string | null, province?: string | null, provinceCode?: string | null, zip?: string | null } | null } | null }, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode }, totalAmount: { amount: string, currencyCode: CurrencyCode } }, lines: { edges: Array<{ node:
        | { id: string, quantity: number, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode }, totalAmount: { amount: string, currencyCode: CurrencyCode } }, discountAllocations: Array<
            | { discountedAmount: { amount: string, currencyCode: CurrencyCode } }
            | { discountedAmount: { amount: string, currencyCode: CurrencyCode } }
            | { discountedAmount: { amount: string, currencyCode: CurrencyCode } }
          >, merchandise: { availableForSale: boolean, currentlyNotInStock: boolean, id: string, quantityAvailable?: number | null, requiresShipping: boolean, sku?: string | null, title: string, weight?: number | null, weightUnit: WeightUnit, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, price: { amount: string, currencyCode: CurrencyCode }, product: { handle: string, title: string, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }, selectedOptions: Array<{ name: string, value: string }>, unitPrice?: { amount: string, currencyCode: CurrencyCode } | null }, sellingPlanAllocation?: { sellingPlan: { name: string } } | null }
        | Record<PropertyKey, never>
       }>, pageInfo: { endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } };

export type CartLineFragment = { id: string, quantity: number, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode }, totalAmount: { amount: string, currencyCode: CurrencyCode } }, discountAllocations: Array<
    | { discountedAmount: { amount: string, currencyCode: CurrencyCode } }
    | { discountedAmount: { amount: string, currencyCode: CurrencyCode } }
    | { discountedAmount: { amount: string, currencyCode: CurrencyCode } }
  >, merchandise: { availableForSale: boolean, currentlyNotInStock: boolean, id: string, quantityAvailable?: number | null, requiresShipping: boolean, sku?: string | null, title: string, weight?: number | null, weightUnit: WeightUnit, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, price: { amount: string, currencyCode: CurrencyCode }, product: { handle: string, title: string, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }, selectedOptions: Array<{ name: string, value: string }>, unitPrice?: { amount: string, currencyCode: CurrencyCode } | null }, sellingPlanAllocation?: { sellingPlan: { name: string } } | null };
...
export type CustomerFragment = { acceptsMarketing: boolean, createdAt: string, displayName: string, email?: string | null, firstName?: string | null, id: string, lastName?: string | null, numberOfOrders: string, phone?: string | null, tags: Array<string>, updatedAt: string, addresses: { edges: Array<{ node: { address1?: string | null, address2?: string | null, city?: string | null, company?: string | null, country?: string | null, countryCodeV2?: CountryCode | null, firstName?: string | null, formatted: Array<string>, formattedArea?: string | null, id: string, lastName?: string | null, latitude?: number | null, longitude?: number | null, name?: string | null, phone?: string | null, province?: string | null, provinceCode?: string | null, zip?: string | null } }> }, defaultAddress?: { address1?: string | null, address2?: string | null, city?: string | null, company?: string | null, country?: string | null, countryCodeV2?: CountryCode | null, firstName?: string | null, formatted: Array<string>, formattedArea?: string | null, id: string, lastName?: string | null, latitude?: number | null, longitude?: number | null, name?: string | null, phone?: string | null, province?: string | null, provinceCode?: string | null, zip?: string | null } | null, orders: { edges: Array<{ node: { canceledAt?: string | null, currencyCode: CurrencyCode, customerUrl?: string | null, edited: boolean, email?: string | null, fulfillmentStatus: OrderFulfillmentStatus, id: string, name: string, orderNumber: number, processedAt: string, statusUrl: string, lineItems: { edges: Array<{ node: { quantity: number, title: string, variant?: { availableForSale: boolean, currentlyNotInStock: boolean, id: string, quantityAvailable?: number | null, requiresShipping: boolean, sku?: string | null, title: string, weight?: number | null, weightUnit: WeightUnit, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, price: { amount: string, currencyCode: CurrencyCode }, product: { handle: string, title: string, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }, selectedOptions: Array<{ name: string, value: string }>, unitPrice?: { amount: string, currencyCode: CurrencyCode } | null } | null } }> }, shippingAddress?: { address1?: string | null, address2?: string | null, city?: string | null, company?: string | null, country?: string | null, countryCodeV2?: CountryCode | null, firstName?: string | null, formatted: Array<string>, formattedArea?: string | null, id: string, lastName?: string | null, latitude?: number | null, longitude?: number | null, name?: string | null, phone?: string | null, province?: string | null, provinceCode?: string | null, zip?: string | null } | null, subtotalPrice?: { amount: string, currencyCode: CurrencyCode } | null, totalPrice: { amount: string, currencyCode: CurrencyCode }, totalRefunded: { amount: string, currencyCode: CurrencyCode }, totalShippingPrice: { amount: string, currencyCode: CurrencyCode }, totalTax?: { amount: string, currencyCode: CurrencyCode } | null } }> }, wishlist?: { namespace: string, key: string, type: string, updatedAt: string, references?: { edges: Array<{ node:
          | { availableForSale: boolean, createdAt: string, description: string, descriptionHtml: string, handle: string, id: string, isGiftCard: boolean, onlineStoreUrl?: string | null, productType: string, publishedAt: string, tags: Array<string>, title: string, totalInventory?: number | null, trackingParameters?: string | null, updatedAt: string, compareAtPriceRange: { maxVariantPrice: { amount: string, currencyCode: CurrencyCode }, minVariantPrice: { amount: string, currencyCode: CurrencyCode } }, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, media: { edges: Array<{ node:
                  | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string } | null }
                  | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                  | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ filesize: number, format: string, mimeType: string, url: string }> }
                  | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ format: string, height: number, mimeType: string, url: string, width: number }> }
                 }> }, options: Array<{ id: string, name: string, optionValues: Array<{ id: string, name: string, swatch?: { color?: string | null, image?:
                    | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                    | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                    | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                    | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                   | null } | null }> }>, priceRange: { maxVariantPrice: { amount: string, currencyCode: CurrencyCode }, minVariantPrice: { amount: string, currencyCode: CurrencyCode } }, variants: { edges: Array<{ node: { availableForSale: boolean, currentlyNotInStock: boolean, id: string, quantityAvailable?: number | null, requiresShipping: boolean, sku?: string | null, title: string, weight?: number | null, weightUnit: WeightUnit, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, price: { amount: string, currencyCode: CurrencyCode }, product: { handle: string, title: string, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }, selectedOptions: Array<{ name: string, value: string }>, unitPrice?: { amount: string, currencyCode: CurrencyCode } | null } }> }, filter_color?: { key: string, value: string, references?: { edges: Array<{ node:
                    | { handle: string, id: string, fields: Array<{ key: string, value?: string | null }> }
                    | Record<PropertyKey, never>
                   }> } | null } | null, matching_colors?: { key: string, value: string, references?: { edges: Array<{ node:
                    | { availableForSale: boolean, handle: string, id: string, options: Array<{ id: string, name: string, optionValues: Array<{ id: string, name: string, swatch?: { color?: string | null, image?:
                              | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                              | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                              | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                              | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                             | null } | null }> }> }
                    | Record<PropertyKey, never>
                   }> } | null } | null, details?: { key: string, value: string } | null, shipping?: { key: string, value: string } | null }
          | Record<PropertyKey, never>
         }> } | null } | null };

export type FilterFragment = { id: string, label: string, type: FilterType, values: Array<{ count: number, id: string, input: string, label: string, swatch?: { color?: string | null, image?: { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null } | null } | null }> };
...
type Media_ExternalVideo_Fragment = { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string } | null };

type Media_MediaImage_Fragment = { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null };

type Media_Model3d_Fragment = { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ filesize: number, format: string, mimeType: string, url: string }> };

type Media_Video_Fragment = { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ format: string, height: number, mimeType: string, url: string, width: number }> };
...
export type ProductOptionFragment = { id: string, name: string, optionValues: Array<{ id: string, name: string, swatch?: { color?: string | null, image?:
        | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
        | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
        | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
        | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
...
export type ProductSummaryFragment = { availableForSale: boolean, createdAt: string, handle: string, id: string, productType: string, publishedAt: string, tags: Array<string>, title: string, updatedAt: string, compareAtPriceRange: { maxVariantPrice: { amount: string, currencyCode: CurrencyCode }, minVariantPrice: { amount: string, currencyCode: CurrencyCode } }, media: { edges: Array<{ node:
        | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string } | null }
        | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
        | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ filesize: number, format: string, mimeType: string, url: string }> }
        | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ format: string, height: number, mimeType: string, url: string, width: number }> }
          ...
          | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
          | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
         | null } | null }> }>, priceRange: { maxVariantPrice: { amount: string, currencyCode: CurrencyCode }, minVariantPrice: { amount: string, currencyCode: CurrencyCode } } };
...
export type CartCreateMutation = { cartCreate?: { cart?: { checkoutUrl: string, createdAt: string, id: string, totalQuantity: number, updatedAt: string, buyerIdentity: { countryCode?: CountryCode | null, email?: string | null, phone?: string | null, customer?: { displayName: string, email?: string | null, id: string, defaultAddress?: { address1?: string | null, address2?: string | null, city?: string | null, company?: string | null, country?: string | null, countryCodeV2?: CountryCode | null, firstName?: string | null, formatted: Array<string>, formattedArea?: string | null, id: string, lastName?: string | null, latitude?: number | null, longitude?: number | null, name?: string | null, phone?: string | null, province?: string | null, provinceCode?: string | null, zip?: string | null } | null } | null }, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode }, totalAmount: { amount: string, currencyCode: CurrencyCode } }, lines: { edges: Array<{ node:
            | { id: string, quantity: number, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode }, totalAmount: { amount: string, currencyCode: CurrencyCode } }, discountAllocations: Array<
              ...
              >, merchandise: { availableForSale: boolean, currentlyNotInStock: boolean, id: string, quantityAvailable?: number | null, requiresShipping: boolean, sku?: string | null, title: string, weight?: number | null, weightUnit: WeightUnit, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, price: { amount: string, currencyCode: CurrencyCode }, product: { handle: string, title: string, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }, selectedOptions: Array<{ name: string, value: string }>, unitPrice?: { amount: string, currencyCode: CurrencyCode } | null }, sellingPlanAllocation?: { sellingPlan: { name: string } } | null }
            | Record<PropertyKey, never>
           }>, pageInfo: { endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } } | null, userErrors: Array<{ code?: CartErrorCode | null, field?: Array<string> | null, message: string }> } | null };
...
export type CartQuery = { cart?: { checkoutUrl: string, createdAt: string, id: string, totalQuantity: number, updatedAt: string, buyerIdentity: { countryCode?: CountryCode | null, email?: string | null, phone?: string | null, customer?: { displayName: string, email?: string | null, id: string, defaultAddress?: { address1?: string | null, address2?: string | null, city?: string | null, company?: string | null, country?: string | null, countryCodeV2?: CountryCode | null, firstName?: string | null, formatted: Array<string>, formattedArea?: string | null, id: string, lastName?: string | null, latitude?: number | null, longitude?: number | null, name?: string | null, phone?: string | null, province?: string | null, provinceCode?: string | null, zip?: string | null } | null } | null }, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode }, totalAmount: { amount: string, currencyCode: CurrencyCode } }, lines: { edges: Array<{ node:
          | { id: string, quantity: number, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode }, totalAmount: { amount: string, currencyCode: CurrencyCode } }, discountAllocations: Array<
            ...
            >, merchandise: { availableForSale: boolean, currentlyNotInStock: boolean, id: string, quantityAvailable?: number | null, requiresShipping: boolean, sku?: string | null, title: string, weight?: number | null, weightUnit: WeightUnit, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, price: { amount: string, currencyCode: CurrencyCode }, product: { handle: string, title: string, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }, selectedOptions: Array<{ name: string, value: string }>, unitPrice?: { amount: string, currencyCode: CurrencyCode } | null }, sellingPlanAllocation?: { sellingPlan: { name: string } } | null }
          | Record<PropertyKey, never>
         }>, pageInfo: { endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } } | null };
...
export type CollectionQuery = { collection?: { description: string, descriptionHtml: string, handle: string, id: string, title: string, trackingParameters?: string | null, updatedAt: string, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, products: { filters: Array<{ id: string, label: string, type: FilterType, values: Array<{ count: number, id: string, label: string, swatch?: { color?: string | null, image?: { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null } | null } | null }> }>, edges: Array<{ node: { availableForSale: boolean, createdAt: string, handle: string, id: string, productType: string, publishedAt: string, tags: Array<string>, title: string, updatedAt: string, compareAtPriceRange: { maxVariantPrice: { amount: string, currencyCode: CurrencyCode }, minVariantPrice: { amount: string, currencyCode: CurrencyCode } }, media: { edges: Array<{ node:
                ...
                | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ format: string, height: number, mimeType: string, url: string, width: number }> }
                  ...
                  | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                  | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                 | null } | null }> }>, priceRange: { maxVariantPrice: { amount: string, currencyCode: CurrencyCode }, minVariantPrice: { amount: string, currencyCode: CurrencyCode } } } }>, pageInfo: { endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } } | null };
          ...
          | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ format: string, height: number, mimeType: string, url: string, width: number }> }
           ...
           | null } | null }> }>, priceRange: { maxVariantPrice: { amount: string, currencyCode: CurrencyCode }, minVariantPrice: { amount: string, currencyCode: CurrencyCode } }, variants: { edges: Array<{ node: { availableForSale: boolean, currentlyNotInStock: boolean, id: string, quantityAvailable?: number | null, requiresShipping: boolean, sku?: string | null, title: string, weight?: number | null, weightUnit: WeightUnit, compareAtPrice?: { amount: string, currencyCode: CurrencyCode } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, price: { amount: string, currencyCode: CurrencyCode }, product: { handle: string, title: string, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }, selectedOptions: Array<{ name: string, value: string }>, unitPrice?: { amount: string, currencyCode: CurrencyCode } | null } }> }, filter_color?: { key: string, value: string, references?: { edges: Array<{ node:
            ...
            | { availableForSale: boolean, handle: string, id: string, options: Array<{ id: string, name: string, optionValues: Array<{ id: string, name: string, swatch?: { color?: string | null, image?:
                     ...
                     | null } | null }> }> }
            | Record<PropertyKey, never>
           }> } | null } | null, details?: { key: string, value: string } | null, shipping?: { key: string, value: string } | null } | null };
...
export type ProductIdsQuery = { nodes: Array<
    | { availableForSale: boolean, createdAt: string, description: string, descriptionHtml: string, handle: string, id: string, isGiftCard: boolean, onlineStoreUrl?: string | null, productType: string, publishedAt: string, tags: Array<string>, title: string, totalInventory?: number | null, trackingParameters?: string | null, updatedAt: string, compareAtPriceRange: { maxVariantPrice: { amount: string, currencyCode: CurrencyCode }, minVariantPrice: { amount: string, currencyCode: CurrencyCode } }, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, media: { edges: Array<{ node:
            | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string } | null }
            | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
            | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ filesize: number, format: string, mimeType: string, url: string }> }
...
export type SearchQuery = { search: { totalCount: number, filters: Array<{ id: string, label: string, type: FilterType, values: Array<{ count: number, id: string, label: string, swatch?: { color?: string | null, image?: { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null } | null } | null }> }>, edges: Array<{ node:
        | { availableForSale: boolean, createdAt: string, description: string, descriptionHtml: string, handle: string, id: string, isGiftCard: boolean, onlineStoreUrl?: string | null, productType: string, publishedAt: string, tags: Array<string>, title: string, totalInventory?: number | null, trackingParameters?: string | null, updatedAt: string, compareAtPriceRange: { maxVariantPrice: { amount: string, currencyCode: CurrencyCode }, minVariantPrice: { amount: string, currencyCode: CurrencyCode } }, featuredImage?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null, media: { edges: Array<{ node:
                | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string } | null }
                | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, image?: { altText?: string | null, height?: number | null, id?: string | null, url: string, width?: number | null } | null }
                | { alt?: string | null, id: string, mediaContentType: MediaContentType, previewImage?: { url: string, altText?: string | null, height?: number | null, id?: string | null, width?: number | null } | null, sources: Array<{ filesize: number, format: string, mimeType: string, url: string }> }
...
export type SearchFiltersQueryVariables = Exact<{
  query: Scalars['String']['input'];
  country?: InputMaybe<CountryCode>;
  language?: InputMaybe<LanguageCode>;
}>;
...
export type SitemapCollectionsQuery = { collections: { edges: Array<{ node: { handle: string, updatedAt: string } }> } };
...
export type SitemapProductsQuery = { products: { edges: Array<{ node: { handle: string, updatedAt: string } }> } };
